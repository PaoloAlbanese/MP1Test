...
* In Developer Tools, on small screens, the webpage may appear to show a gap on the right ![hand side](https://github.com/PaoloAlbanese/MP1Test/blob/master/images/dev_tools_sm_screens.PNG);\however, if the browser is refreshed, the normal layout is restored. I don't know what causes this.
